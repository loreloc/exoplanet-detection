...
\section{Conclusion}
  ...
  \begin{table}
    ...
    \begin{tabular}{|c c c c|}
      ...
      \hline
      \textbf{Random Forest w/Hyperband} & \textbf{0.877} & \textbf{0.902} & \textbf{0.889} \\
      \hline
    \end{tabular}
