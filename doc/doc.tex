...
\section{Conclusion}
  ...
  It means that the predictions cannot be explained and the features importance cannot be evaluated easily.
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[scale=1.85]
      ...
      \coordinate[label={\textbf{415}}] (TP) at (0.5, 1.33);
      \coordinate[label={ 25}] (FN) at (0.5, 0.33);
      \coordinate[label={ 28}] (FP) at (1.5, 1.33);
      \coordinate[label={\textbf{704}}] (TN) at (1.5, 0.33);
    \end{tikzpicture}
