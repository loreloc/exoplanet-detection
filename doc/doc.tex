...
\begin{table}
  ...
  \begin{tabular}{|c c c c|}
    ...
    \hline
    2-layer NN & 0.919 & \underline{0.926} & 0.922 \\
    \hline
...
\end{table}
  ...
  \begin{table}
    ...
    \begin{tikzpicture}[scale=1.67]
      ...
      \coordinate[label={\textbf{392}}] (TP) at (0.5, 1.33);
      \coordinate[label={ 30}] (FN) at (0.5, 0.33);
      \coordinate[label={ 23}] (FP) at (1.5, 1.33);
      \coordinate[label={\textbf{676}}] (TN) at (1.5, 0.33);
    \end{tikzpicture}
