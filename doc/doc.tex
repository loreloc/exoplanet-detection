...
\section{Conclusion}
  ...
  \begin{table}
    ...
    \begin{tabular}{|c c c c|}
      ...
      \hline\hline
      k-NN & 0.718 & 0.857 & 0.782 \\
      \hline
      SVC & 0.775& 0.856 & 0.813 \\
      \hline
      2-layer NN & 0.833 & 0.881 & 0.856 \\
      \hline
      \textbf{Random Forest w/\texttt{Hyperband}} & \textbf{0.875} & \textbf{0.880} & \textbf{0.878} \\
      \hline
    \end{tabular}
  ...
  \begin{table}
    ...
    \begin{tikzpicture}[scale=1.67]
      ...
      \coordinate[label={\textbf{405}}] (PP) at (0.5, 1.33);
      \coordinate[label={ 55}] (NP) at (0.5, 0.33);
      \coordinate[label={ 58}] (PN) at (1.5, 1.33);
  ...
  \begin{table}
    ...
    \hline\hline
    7 & Planetary Radius & 0.141 \\
    5 & Planet-Star Radius Ratio & 0.126 \\
    1 & Orbital Period & 0.073 \\
    4 & Transit Depth & 0.072 \\
    6 & Fitted Stellar Density & 0.063 \\
    \hline
    \end{tabular}
