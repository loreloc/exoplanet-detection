...
\begin{table}
  ...
  \begin{tabular}{|c c c c|}
    ...
    \hline
    \textbf{Random Forest w/HB} & 0.933 & \textbf{0.945} & \textbf{0.939} \\
    \hline
  \end{tabular}
...
\end{table}
  ...
  \begin{table}
    ...
    \begin{tikzpicture}[scale=1.67]
      ...
      \coordinate[label={\textbf{416}}] (TP) at (0.5, 1.33);
      \coordinate[label={ 24}] (FN) at (0.5, 0.33);
      \coordinate[label={ 30}] (FP) at (1.5, 1.33);
      \coordinate[label={\textbf{702}}] (TN) at (1.5, 0.33);
    \end{tikzpicture}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Most important features importances.}
