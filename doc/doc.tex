...
\author{Lorenzo Loconte \\ \small Knowledge Engeneering Project \\ \small University of Bari Aldo Moro, Department of Informatics}
...
\section{Introduction}
  \paragraph{Kepler Object of Interest}
    ...
    The goal of this work is to build a model (using supervisioned \textit{Machine Learning}) that is capable to determinate if a hypotetical exoplanet can be confirmed or is just false positive.
  ...
  \paragraph{Random Forests}
    ...
    In supervisioned \textit{Machine Learning}, bias consists of errouneous assumptions about the data while variance is a measure of sensitivity to the noise in the training data.
...
\section{Conclusion}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[scale=1.85]
      ...
      \coordinate[label={\textbf{413}}] (TP) at (0.5, 1.33);
      \coordinate[label={ 27}] (FN) at (0.5, 0.33);
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        ylabel=Importance,
        xlabel=Feature \#,
        symbolic x coords={21, 5, 3, 19, 20},
        bar width=16pt,
        ymin=0.0, ymax=0.25,
