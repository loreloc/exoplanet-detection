...
\section{Conclusion and Results}
  ...
  \begin{table}[H]
    ...
    \begin{tikzpicture}[scale=1.5]
      ...
      \coordinate[label={\textbf{408}}] (PP) at (0.5, 1.33);
      \coordinate[label={ 53}] (NP) at (0.5, 0.33);
      \coordinate[label={ 71}] (PN) at (1.5, 1.33);
      \coordinate[label={\textbf{897}}] (NN) at (1.5, 0.33);
    \end{tikzpicture}
...
\end{multicols}
  ...
  \begin{table}
    ...
    \begin{tabular}{|c c c c c|}
      ...
      \hline
      SVC & regularizer=1.0, rbf kernel, gamma scale & 0.925 & 0.875 & 0.899 \\
      \hline
      2-layer NN & 100 hidden units, relu activation, adam & 0.930 & 0.917 & 0.926 \\
      \hline
      \textbf{Random Forest} & \textbf{auto-tuned hyperparameters} & \textbf{0.943} & \textbf{0.939} & \textbf{0.941} \\
      \hline
    \end{tabular}
    \caption{Precision, recall and $F_{1}$ metrics of several models for comparison. The hyperparameters of \textit{Random Forest} were optimized automatically. In this table it was built with the following hyperparameters: 90 estimators, 4 minimum samples to split an internal node and 5 features per tree.}
